...
int CYGWIN64_ABI op_mproflinefetch(), op_mproflinestart();
...
int CYGWIN64_ABI op_mprofforlcldow(), op_mprofforlcldol(), op_mprofforlcldob(), op_mprofforchk1();
int CYGWIN64_ABI op_linefetch(), op_linestart();
int op_extexfun(), op_extcall(), op_exfun(), op_forlcldo();
int op_callw(), op_calll(), op_callb();
int op_callspw(), op_callspl(), op_callspb();
int CYGWIN64_ABI op_forlcldow(), op_forlcldol(), op_forlcldob(), op_forchk1();
